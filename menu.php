  ...
  <!--Navbar-->
    <nav class="navbar navbar-dark navbar-expand-lg shadow-sm fixed-top" style="background-color: #850E35;">
      ...
      <!--Main content-->
        <div class=" col col-12 col-lg-9 main-content pt-3 px-0">
          ...
          <div class="row products mt-4 mb-4 justify-content-start">
            <?php 
            foreach (query("SELECT judul,diskon,akhir,desk,code FROM promo") as $promo) : 
            $awal = $promo['akhir'] + $promo['diskon'];?>
            <div class="card mb-3 mx-2 px-0" style="width: 18rem;" data-name="<?= $promo ['desk']; ?>">
            ...
            <div class="row products mt-4 mb-4 justify-content-start">
            <?php 
            foreach (query("SELECT judul,diskon,akhir,desk,code FROM fav") as $fav) : 
            ...
            <?php endforeach; ?>
              ...
              <div class="row products mt-4 mb-4 justify-content-start">
              <?php 
              foreach (query("SELECT judul,diskon,akhir,desk,code FROM nasi") as $nasi) : 
              ...
              <?php endforeach; ?>
                ...
                <div class="row products mt-4 mb-4 justify-content-start">
              <?php 
              foreach (query("SELECT judul,diskon,akhir,desk,code FROM spaghetti") as $spaghetti) : 
      ...
      <div class="products-preview">
        ...
        <div class="preview active" data-target="nasgor">
          <i class="bi bi-x"></i>
          <img class="product-image" src="img/test.png" alt="" width="190px" height="140px">
          <h3 class="product-title">Nasi Goreng Ala Rawr</h3>
            ...
            <h3 class="preview-harga">Rp 20000</h3><br>
              <a href="#" class="btn add-to-cart mx-3 px-4">Add to Cart</a>
          </div>
        </div>
        <div class="preview active" data-target="miegor">
          <div class="preview-desc">
          <i class="bi bi-x"></i>
          <img class="product-image" src="img/test2.png" alt="" width="190px" height="140px">
          <h3 class="product-title">Mie Goreng Ala Rawr</h3>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            ...
            <span>( 100 )</span>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa, corrupti?</p>
            <h3 class="preview-harga">Rp 18000</h3><br>
              <a href="#" class="btn add-to-cart mx-3 px-4">Add to Cart</a>
          </div>
        </div>
        <div class="preview active" data-target="bolognese">
          <div class="preview-desc">
          <i class="bi bi-x"></i>
          <img class="product-image" src="img/test.png" alt="" width="190px" height="140px">
          <h3 class="product-title">Spaghetti Bolognese Ala Rawr</h3>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            ...
            <span>( 150 )</span>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa, corrupti?</p>
            <h3 class="preview-harga">Rp 24000</h3><br>
              <a href="#" class="btn add-to-cart mx-3 px-4">Add to Cart</a>
          </div>
        </div>
        <div class="preview active" data-target="bakar">
          <div class="preview-desc">
          <i class="bi bi-x"></i>
          <img class="product-image" src="img/test2.png" alt="" width="190px" height="140px">
          <h3 class="product-title">Nasi Bakar Ala Rawr</h3>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            ...
            <span>( 100 )</span>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa, corrupti?</p>
            <h3 class="preview-harga">Rp 22000</h3><br>
              <a href="#" class="btn add-to-cart mx-3 px-4">Add to Cart</a>
          </div>
        </div>
        <div class="preview active" data-target="campur">
          <div class="preview-desc">
          <i class="bi bi-x"></i>
          <img class="product-image" src="img/test2.png" alt="" width="190px" height="140px">
          <h3 class="product-title">Nasi Campur Ala Rawr</h3>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
        ...
        <div class="preview active" data-target="carbonara">
          <div class="preview-desc">
          <i class="bi bi-x"></i>
          <img class="product-image" src="img/test.png" alt="" width="190px" height="140px">
          <h3  class="product-title">Spaghetti Carbonara Ala Rawr</h3>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
